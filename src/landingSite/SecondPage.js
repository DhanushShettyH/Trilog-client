...
export default function SecondPage() {
  ...
  return (
    <section>
      <div className="container pl-5 md:pl-10 w-[100%] h-screen m-auto overflow-hidden relative">
        ...
        <div className="wrapper w-full grid grid-cols-12">
          <div className="lwrap w-[90%] col-span-5">
            <h1 className="absolute opacity-0 bottom-[33%] md:bottom-[30%] w-full md:w-[500px] elmt text-[45px] md:text-[50px] font-semibold capitalize leading-[110%] text-[rgba(20,19,19,1)] mt-[40px]">
              The Future of <span className=" font-bold">Technology</span> is
              way to better than anything
            </h1>
            <p className="absolute opacity-0 bottom-[19%] md:bottom-[17%] w-full md:w-[500px] elmt p-[20px 80px 30px 0px]">
             be a part of rising star, and explore new
              people everyday share your opinion and embrase others.
            </p>
            <div className="absolute opacity-0 bottom-[11%] md:bottom-[10%] w-full md:w-[500px] elmt button grid grid-cols-12 gap-[20px] mt-[30px]">
              <Link
